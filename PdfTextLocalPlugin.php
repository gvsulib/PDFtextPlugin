 ...
 */
class PdfTextLocalPlugin extends Omeka_Plugin_AbstractPlugin
{
    ...
    public function hookInstall()
    {
        ...
        insert_element_set(
            array('name' => self::ELEMENT_SET_NAME, 'description' => 'Text capture metadata for PDF documents'),
    ...
    {
        $logfile = fopen("/home/bitnami/htdocs/plugins/PdfText/models/testlog.log", "a");
        ...
        foreach ($itemFiles as $itemFile) {
            if (in_array($itemFile->mime_type, $this->_pdfMimeTypes)) {$count++;}
            release_object($itemFile);
        }
